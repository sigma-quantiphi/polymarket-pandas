...
class ClobPublicMixin:
    ...
    def get_orderbooks(self, data: pd.DataFrame) -> DataFrame[OrderbookSchema]:
    ...
    def get_sampling_markets(self, next_cursor: str | None = None) -> SamplingMarketsCursorPage:
        """
    ...
    def get_simplified_markets(self, next_cursor: str | None = None) -> SimplifiedMarketsCursorPage:
        """
    ...
    def get_rebates(self, date: str, maker_address: str) -> DataFrame[RebateSchema]:
        """
